...
const projects = [
  {
    ...
    liveUrl: "#",
    githubUrl: "https://github.com/Dhineshkumar272005"
  },
  {
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            ...
            >
              <Card className="group overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
                ...
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold mb-3 text-slate-900 dark:text-slate-100">{project.title}</h3>
